...
urlpatterns = [
    ...
    path('actualizar/<int:producto_id>/<int:cantidad>/', views.actualizar_cantidad, name='actualizar_cantidad'),
    ...
    path('autocompletar/', views.autocompletar_productos, name='autocompletar_productos'),
]